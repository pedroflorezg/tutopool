...
- Name: pools/request-tutoring.spec.js >> RequestTutoringPage >> muestra selector de tipo (Individual / Grupal)
- Location: tests/e2e/pools/request-tutoring.spec.js:31:3
